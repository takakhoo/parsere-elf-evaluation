...
% The translation-log difference provides candidate evidence for the differing production.
...
\node[font=\bfseries\footnotesize, align=center] (qemu) at (6.6, 5.6)
  {log each input\\under \textsc{qemu}};

\draw[arrow, line width=0.9pt, dashed] (4.7, 3.0) -- (6.0, 3.0);
\node[cflabel] at (5.35, 3.15) {compare};

% ============================================================
% RIGHT COLUMN: trace-derived graph fragment with labeled blocks
% ============================================================

\node[font=\bfseries\small, anchor=west] at (5.55, 4.7) {Candidate labeled graph fragment};
...
% Legend below the trace-derived graph
\node[cflabel, draw=black!30, fill=white, rounded corners=2pt, inner sep=4pt,
      anchor=north, align=left] at (6.6, -0.1)
  {record-pair difference $\Rightarrow$ candidate \texttt{path} label};

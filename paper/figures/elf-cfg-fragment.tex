% Trace-derived graph fragment from the ELF evaluation.
...
% Cross-group arrows showing consecutive-record relationships from out.dot
...
\node[caption, anchor=west, text width=14cm, align=left] at (-3.5, 0.3)
  {Arrows reproduce consecutive-record relationships in the committed \texttt{out.dot}. Dashed styling distinguishes relationships that cross function boundaries; it does not independently establish dynamic call edges.};
